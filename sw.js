...
const PRECACHE_URLS = [
    BASE + '/',
    BASE + '/index.html',
    BASE + '/pages/phishing.html',
    BASE + '/pages/ciberseguridad.html',
    BASE + '/pages/videojuegos.html',
    BASE + '/pages/redes.html',
    BASE + '/pages/grooming.html',
    BASE + '/pages/post-detalle.html',
    BASE + '/pages/privacidad.html',
